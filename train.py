...
# Basic options
parser.add_argument('--content_dir', default='./datasets/content', type=str,   
                    help='Directory path to a batch of content images')
parser.add_argument('--style_dir', default='./datasets/style', type=str,  #wikiart dataset crawled from https://www.wikiart.org/
